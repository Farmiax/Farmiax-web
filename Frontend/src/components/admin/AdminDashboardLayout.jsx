      ...
      <aside className={`admin-sidebar ${isSidebarOpen ? '' : 'collapsed'}`}>
        <div className="admin-sidebar-header">
          {isSidebarOpen ? (
            ...
            <span className="admin-badge-pill" style={{ margin: '0 auto' }}>ADM</span>
          )}
          <button
      ...
      <div className="admin-main-wrapper">
        ...
        <header className="admin-top-header">
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '6px 14px', background: 'rgba(34, 197, 94, 0.15)', border: '1px solid rgba(74, 222, 128, 0.3)', borderRadius: '999px' }}>
              <span style={{ width: '8px', height: '8px', borderRadius: '50%', background: '#4ADE80', display: 'inline-block' }} />
              <span style={{ fontSize: '12px', fontWeight: 800, color: '#4ADE80' }}>LIVE SERVER CONNECTED</span>
            </div>

            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
              <div style={{ width: '36px', height: '36px', borderRadius: '50%', background: '#CA8A04', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 900, color: '#000000', fontSize: '14px' }}>
                A
              </div>
