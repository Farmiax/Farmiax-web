...
const CustomerProfile = () => {
  ...
  const [metrics, setMetrics] = useState({ orders: 0, farmers: 0 });
        ...
        <div className="dashboard-center-col">
          ...
          <div className="customer-welcome-banner">
            <div className="customer-welcome-content">
              <p className="customer-welcome-sub">Welcome back,</p>
              <h1 className="customer-welcome-title">{user?.fullName}! 👋</h1>
              <p className="customer-welcome-desc">
                Good to see you again. Discover fresh products from trusted farmers.
              </p>
              <button className="customer-welcome-btn" onClick={() => navigate('/customer/shop')}>Shop Now</button>
            </div>
          </div>
            ...
            <div className="cart-widget-header">
              <div className="cart-widget-left">
                ...
                <div className="cart-widget-info">
                  <h4>Your Cart</h4>
                  <p>{cartProducts?.length || 0} Items</p>
                </div>
              </div>
              <span className="cart-widget-price">
